				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div id="kt_header" class="header header-fixed">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							<?php echo $this->load->view('view_topbar'); ?>
						</div>
						<!--end::Container-->
					</div>
					<!--end::Header-->
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						...
						if($this->session->userdata('photo') <> NULL){
							$photo = 'assets/media/users/'.$this->session->userdata('photo');
						} else {
							$photo = 'assets/media/users/default.jpg';
						}
						?>
						<div class="symbol-label" style="background-image:url('<?php echo $photo; ?>')"></div>
					...
					<div class="d-flex flex-column">
						...
						<div class="text-muted mt-1"><?php echo $this->session->userdata('occupation') ?></div>
						<div class="navi mt-2">
							...
							<a href="authentication/logout" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
						</div>
					</div>
				</div>
				<!--end::Header-->
