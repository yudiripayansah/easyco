...
class CreateKopPembiayaanTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('kop_pembiayaan', function (Blueprint $table) {
            $table->id();
            $table->string('id_pembiayaan', 32)->unique()->default(DB::raw('uuid()'));
            ...
            $table->decimal('pokok', 14, 0)->nullable(TRUE)->default(0);
            $table->decimal('margin', 14, 0)->nullable(TRUE)->default(0);
            ...
            $table->decimal('angsuran_minggon', 14, 0)->nullable(TRUE)->default(0);
            $table->decimal('biaya_administrasi', 14, 0)->nullable(TRUE)->default(0);
            $table->decimal('biaya_asuransi_jiwa', 14, 0)->nullable(TRUE)->default(0);
            $table->decimal('biaya_asuransi_jaminan', 14, 0)->nullable(TRUE)->default(0);
            $table->decimal('biaya_notaris', 14, 0)->nullable(TRUE)->default(0);
            $table->decimal('tabungan_persen', 14, 0)->nullable(TRUE)->default(0);
            $table->decimal('dana_kebajikan', 14, 0)->nullable(TRUE)->default(0);
            ...
            $table->decimal('saldo_minggon', 14, 0)->nullable(TRUE)->default(0);
            ...
            $table->decimal('dana_sendiri', 14, 0)->nullable(TRUE)->default(0);
            $table->decimal('dana_kreditur', 14, 0)->nullable(TRUE)->default(0);
