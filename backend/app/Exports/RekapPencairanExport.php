...
class RekapPencairanExport implements FromView
{
    use Exportable;
    ...
    function view(): View
    {
        ...
        $show = KopPembiayaan::rekap_pencairan($this->kode_cabang, $this->rekap_by, $this->from_date, $this->thru_date);
