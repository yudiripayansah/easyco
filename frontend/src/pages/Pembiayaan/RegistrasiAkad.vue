<template>
  <div>
    ...
    <b-modal title="Form Registrasi Akad" id="modal-form" hide-footer size="xl" centered>
        ...
        <b-row>
          ...
          <b-col cols="12" sm="4">
            <b-form-group label="Nama">
              <b-select v-model="form.data.no_anggota" :options="opt.anggota" @change="calculateForm()" />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="4">
          ...
          <b-col cols="12" sm="4">
            <b-form-group label="No Anggota">
              <b-input v-model="pengajuan.no_anggota" disabled />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="4">
            <b-form-group label="No Pengajuan">
              <b-input v-model="pengajuan.no_pengajuan" disabled />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="4">
            <b-form-group label="Pembiayaan Ke">
              <b-input v-model="pengajuan.pembiayaan_ke" disabled />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="4">
            <b-form-group label="Jumlah Pengajuan">
              <b-input v-model="pengajuan.jumlah_pengajuan" disabled />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="4">
            <b-form-group label="Peruntukan">
              <b-select v-model="pengajuan.peruntukan" :options="opt.peruntukan" disabled />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="4">
            <b-form-group label="Keterangan">
              <b-textarea v-model="pengajuan.keterangan_peruntukan" rows="5" disabled />
            </b-form-group>
          </b-col>
          <b-col cols="12">
            <hr>
          ...
          <b-col cols="12" sm="6">
            <b-form-group label="Akad/ Produk">
              <b-select v-model="form.data.kode_produk" :options="opt.product" />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="6">
            <b-form-group label="Plafon">
              <b-input v-model="form.data.pokok" type="number" @change="calculateForm()" />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="6">
            <b-form-group label="Margin">
              <b-input v-model="form.data.margin" type="number" @change="calculateForm()" />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="6">
            <b-form-group label="Jangka Waktu">
              <b-row>
                <b-col cols="4">
                  <b-input v-model="form.data.jangka_waktu" type="number" @change="calculateForm()" />
                </b-col>
                <b-col>
          ...
          <b-col cols="12" sm="6">
            ...
            <b-form-group label="Pokok">
              <b-input :value="form.data.angsuran_pokok" disabled />
            </b-form-group>
            <b-form-group label="Margin">
              <b-input :value="form.data.angsuran_margin" disabled />
            </b-form-group>
            <b-form-group label="Minggon">
              <b-input v-model="form.data.angsuran_minggon" type="number" @change="calculateForm()" />
            </b-form-group>
            <b-form-group label="Total">
              <b-input
                :value="(Number(form.data.angsuran_pokok) + Number(form.data.angsuran_margin) + Number(form.data.angsuran_minggon))"
                disabled />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="6">
            ...
            <b-form-group label="Biaya Adm">
              <b-input v-model="form.data.biaya_administrasi" type="number" @change="calculateForm()" />
            </b-form-group>
            <b-form-group label="Asuransi">
              <b-input v-model="form.data.biaya_asuransi_jiwa" type="number" @change="calculateForm()" />
            </b-form-group>
            <b-form-group label="Dana Kebajikan">
              <b-input v-model="form.data.dana_kebajikan" type="number" @change="calculateForm()" />
            </b-form-group>
            ...
            <b-form-group label="Total">
              <b-input
                :value="(Number(form.data.biaya_administrasi) + Number(form.data.biaya_asuransi_jiwa) + Number(form.data.dana_kebajikan) + Number(form.data.tabungan_persen))"
                disabled />
            </b-form-group>
          </b-col>
          <b-col cols="12">
          ...
          <b-col cols="12" sm="6">
            <b-form-group label="Sumber Dana">
              <b-select v-model="form.data.sumber_dana" :options="opt.sumber_dana" />
            </b-form-group>
          </b-col>
          <b-col cols="12" sm="6" v-show="(form.data.sumber_dana == 1)">
            <b-form-group label="Nama Kreditur">
              <b-select v-model="form.data.kode_kreditur" :options="opt.kreditur"/>
            </b-form-group>
          </b-col>
        </b-row>
        <b-row>
