        ...
        <b-row>
          ...
          <b-col cols="6">
            <b-form-group label="Jenis Akad" label-for="jenis_akad">
              <b-form-select
                id="jenis_akad"
                :options="opt.jenis_akad"
                v-model="$v.form.data.jenis_akad.$model"
          ...
          <b-col cols="4">
            <b-form-group label="Saldo Minimal" label-for="saldo_minimal">
              <b-form-input
                id="saldo_minimal"
                v-model="$v.form.data.saldo_minimal.$model"
          ...
          <b-col cols="4">
            <b-form-group label="Jenis Tabungan" label-for="jenis tabungan">
              <b-form-select
                id="jenis_tabungan"
                :options="opt.jenis_tabungan"
                v-model="$v.form.data.jenis_tabungan.$model"
          ...
          <b-col cols="4">
            <b-form-group label="Minimal Kontrak" label-for="minimal_kontrak">
              <b-form-input
                id="minimal_kontrak"
                v-model="$v.form.data.minimal_kontrak.$model"
...
export default {
  ...
  methods: {
    ...
    async doSave(e) {
      ...
      if (!this.$v.form.$anyError) {
        ...
        try {
          ...
          let req = false;
          if (payload.id) {
            req = await easycoApi.prdtabunganUpdate(payload, this.user.token);
          } else {
            req = await easycoApi.prdtabunganCreate(payload, this.user.token);
          }
          let { status } = req.data;
          if (status) {
    ...
    async doUpdate(item) {
      try {
        let req = await easycoApi.prdtabunganDetail(
          `id=${item.id}`,
          this.user.token
        );
    ...
    async doDelete(item, prompt) {
      if (prompt) {
        ...
        try {
          let req = await easycoApi.prdtabunganDelete(
