<template>
  <div>
    ...
    <b-modal title="PREVIEW LAPORAN TRANSAKSI REMBUG" id="modal-pdf" hide-footer size="xl" centered>
      <div id="table-print" class="p-5">
        ...
        <table role="table" aria-busy="false" aria-colcount="6"
          class="table b-table table-striped table-bordered table-sm border" id="__BVID__218"><!----><!---->
  ...
  methods: {
    ...
    async doGetReport() {
      ...
      this.report.items.map((i) => {
        console.log(i)
        this.report.total.angs_pokok= this.report.total.angs_pokok + i.angs_pokok
        this.report.total.angs_margin= this.report.total.angs_margin + i.angs_margin
