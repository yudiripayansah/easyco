        ...
        <b-row no-gutters>
            ...
            <div class="row">
              ...
              <b-col>
                <b-input-group prepend="Anggota">
                  <b-form-select v-model="paging.anggota" :options="opt.anggota" />
                </b-input-group><br>
              </b-col>
            </div>
            <div class="row">
          ...
          <b-col cols="12">
            ...
            <b-table responsive bordered outlined small striped hover :fields="table.fields" :items="table.items"
              ...
              <b-button variant="success" size="xs" class="mx-1" @click="doUpdate(data.item)" v-b-tooltip.hover title="Lihat Statement">
                Lihat Statement
              </b-button>
            </template>
            </b-table>
